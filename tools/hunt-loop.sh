...
# The whole hunt runs under the database lock, not each lap. See
# tests/test_database.py::LOCK_PATH for why the lock exists; this is its other
# side, reading the same $RK_TEST_CLUSTER_LOCK override (ticket 197).
#
