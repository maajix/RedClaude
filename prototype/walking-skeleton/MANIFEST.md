...
Schema comes from `prototype/schema/migrations/` on this branch's own baseline
(`prototype/migrations-fold` `013ee26`), never from a copied file.

| vendored path | source branch | sha | source path |
| --- | --- | --- | --- |
| `vendor/eval-harness/*` | `prototype/eval-harness` | `4750a39` | `prototype/eval-harness/*` |
| `vendor/scope-proxy/*` | `prototype/scope-proxy` | `5e5ca2e` | `prototype/scope-proxy/*` |
| `vendor/sdk-auth-probe/*` | `prototype/sdk-auth-probe` | `9d5b97e` | `prototype/sdk-auth-probe/*` |
