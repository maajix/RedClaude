...
class OperatorSurfaceTest(unittest.TestCase):
    ...
    SURFACE = (
        ...
        "--content-sha256", "--content-type", "--correlator", "--database",
        "--deny", "--discovery", "--egress", "--every", "--finding", "--fixture",
        "--for", "--from", "--gate", "--grant-hours", "--header", "--help",
        "--host", "--identity", "--image", "--impact", "--into", "--key",
        "--kind", "--label", "--limit", "--method", "--narrative", "--offset",
        "--out", "--panel", "--peer", "--plan", "--playbook", "--port",
        "--program", "--proxy", "--reason", "--record", "--redacted",
