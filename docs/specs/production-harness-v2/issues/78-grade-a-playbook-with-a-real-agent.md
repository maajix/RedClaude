...
**Blocked by:** 46 — Evaluate and promote one Playbook; 175 — An evaluation works a Program once and stops before the Playbook; 176 — An evaluation points every Program at a route its fixture does not serve; 177 — A door refusal of one request throws away a whole repeat; 178 — A graded Playbook names a Skill its own role cannot open; 179 — An evaluation selects a second Playbook and loses the first; 180 — A replay is refused a budget it cannot spend; 181 — A spent budget throws away the work it funded; 182 — The refusal preview asks half the bar; 183 — A Test that settled nothing throws away the repeat that took it; 184 — The last budget reason still throws away the work.
