...
- [ ] **The measurement is in the ticket.** `rk2hunt8`, 2026-08-22. Three Tool
...
- [ ] **The error carries its reason.** Whatever closed TR1 knew something went
...
- [ ] **The preflight asks the door which database it serves.** `rk doctor` and
...
- [ ] **Checked by something that would go red.** A test that a Tool run closed
