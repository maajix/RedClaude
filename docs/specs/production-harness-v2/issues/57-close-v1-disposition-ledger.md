...
- [ ] Ten Android Playbooks, two Android Skills and one Android Agent carry explicit reversible scope-retirement records; one remaining topic is absorbed as reference material.
- [ ] All references and sink packs resolve from at least one bounded Skill or Playbook reference and none is injected globally.
